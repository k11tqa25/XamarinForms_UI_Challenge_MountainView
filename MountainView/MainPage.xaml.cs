...
namespace MountainView
{
    ...
    public partial class MainPage : ContentPage
    {
        ...
        public MainPage()
        {
            ...
            //offscreenHeading.Text = Location.LocationPages[next].Title;
            //offscreenBody.Text = Location.LocationPages[next].Description;
            //offscreenBitmap = BitmapExtensions.LoadBitmapResource(this.GetType(), Location.LocationPages[next].ImageResource);
        }
